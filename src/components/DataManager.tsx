    ...
    <div className="space-y-5">
        ...
        <div className={`flex items-center gap-3 px-4 py-3 rounded-xl border mb-4 ${
          ...
          <div>
            <p className={`text-sm font-semibold ${
              ...
              {status === 'ok' ? '✅ Account storage connected' : status === 'error' ? '❌ Cannot reach server' : '⏳ Connecting…'}
            </p>
            {status === 'ok' && dbPath && (
      ...
      <div className="bg-[#1a1f2e] border border-white/10 rounded-2xl p-5">
        ...
        <div className="space-y-2 text-xs text-gray-400 leading-relaxed">
          <p>✅ <span className="text-white font-medium">Your entries are tied to your account</span> — sign out, come back later, and your personal data is still there after you log in again.</p>
          <p>✅ <span className="text-white font-medium">Not browser-only</span> — data is stored in the app database, not just in the current tab or device session.</p>
          <p>✅ <span className="text-white font-medium">Instant persistence</span> — every entry is written as soon as you save it.</p>
          <p>✅ <span className="text-white font-medium">Portable safety copy</span> — JSON backups let you restore your account history if you ever need to move or recover it.</p>
          <p>⚠️ <span className="text-white font-medium">Best practice</span> — download backups regularly, especially before big imports or cleanup operations.</p>
        </div>
      </div>
