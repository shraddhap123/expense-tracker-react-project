...
export default function App() {
  ...
  const [settingsTab,  setSettingsTab]  = useState<'budget' | 'data'>('budget');
            ...
            <div className="relative group">
              ...
              <div className="absolute right-0 top-full mt-2 w-68 bg-[#1a1f2e] border border-white/10 rounded-xl p-3 shadow-2xl
                ...
                <p className="text-[11px] text-gray-400 leading-relaxed">
                  Downloads your full SQLite database as a <span className="text-white">.json file</span>.
                  Your data already lives in <span className="text-white">expenseiq.db</span> on disk —
                  this is your portable safety copy.
                </p>
              </div>
            </div>
